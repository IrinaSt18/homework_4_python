...
# а значение — имя аргумента. Если ключ не хешируем, используйте его строковое представление. reverse_kwargs(rev=True, acc="YES", 
# stroka=4) -> {True: "rev", "YES": 'acc', 4: "stroka"}
